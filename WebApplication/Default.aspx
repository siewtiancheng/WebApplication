...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <h2>Today’s education problems:</h2>
            <p>
                Children might missed their best time of learning languages due to the wrong learning concept by parents</p>
            <p>
                They educate children based on their age, instead of their learning conditions or ability</p>
            <p>
                Spoon-feeding
            </p>
            <p>
